...
- **Scenario Library** — 32 starter scenarios across 9 categories (Speculative, Science, History, Pop Culture, Internet Mystery, Alternate Reality, Unsettling Everyday, Scary/Weird, Scary Story), searchable and filterable. Each one is a complete content package, not just an idea. **Scary Story** is a narrative category — short horror told straight rather than "what if" speculation — and its renders brand themselves automatically: dark AI visuals, a "follow for more scary stories" CTA card, and horror hashtags in the post kit.
