...
- **Scenario Library** — 40 starter scenarios across 10 categories (Speculative, Science, History, Pop Culture, Internet Mystery, Alternate Reality, Unsettling Everyday, Scary/Weird, Scary Story, True History), searchable and filterable. Each one is a complete content package, not just an idea. The two **story categories** are narrative rather than "what if" speculation, and their renders brand themselves automatically: **Scary Story** (short horror told straight) gets dark AI visuals, a "follow for more scary stories" CTA card, and horror hashtags; **True History** (real documented events — the dancing plague, the Emu War, Wojtek the bear) gets archival AI visuals, a "follow for more true history" CTA card, and history hashtags.
