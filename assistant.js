...
(() => {
  ...
  const KB = [
    ...
    { k: ["seed", "idea", "angle", "inspiration"],
      a: "“New Scenario Seed” (Studio top bar) rotates through fresh what-if prompts across all 8 categories. Or ask me on the Studio page: “give me an idea” — then “make a video about it”." },
