...
(() => {
  ...
  const KB = [
    ...
    { k: ["morning", "every morning", "daily", "automatic scenarios", "fresh drafts", "work break"],
      a: "Every morning (after 6:00, while the studio is running) the dashboard drafts 3 fresh 90s Scary Story packages by itself — they appear in the Produce page's package dropdown with per-beat prompts ready to copy into tryinfer Studio on a break. The Produce page also has two on-demand buttons: 🌅 drafts 3 more scary scenarios, 💭 drafts 3 realistic what-ifs (grounded thought experiments built from real facts — no monsters or magic). Drafting only: nothing renders, bills tryinfer, or posts by itself." },
    ...
    { k: ["scary story", "scary stories", "true history", "horror", "creepy", "story categories", "categories"],
      a: "Besides the what-if categories there are two story categories: Scary Story (narrative horror — the trapped diver, the 3:33 doorbell) and True History (real documented events — the dancing plague, the Emu War). Their videos brand themselves automatically: eerie social-thriller visuals for Scary Story (still, symmetrical, quietly-wrong frames), archival for True History, their own title-card fonts, a matching follow card and outro, and the right hashtags in the post kit. On the Studio page, say “make a scary story about …” or “make a true history video about …” and I'll draft it straight into the right category." }
  ];
